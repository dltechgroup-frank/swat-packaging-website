...
export function getServices(locale: Locale): Service[] {
  const keys = [
    ...
    { slug: 'custom-packaging', key: 'customPackaging', icon: 'gift', badge: '36 Design Centers', sectors: ['medical', 'electronics', 'retail'], image: '/images/sections/custom-packaging.jpg' }, // Custom packaging design
